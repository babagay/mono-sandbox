package gojava.repository;

import gojava.MonoSandboxApp;
import gojava.config.Constants;
import gojava.config.audit.AuditEventConverter;
import gojava.domain.PersistentAuditEvent;
...
import static gojava.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
